...
############################
def process_string_to_array(sentence):  # TODO: Rename this function to reflect what it's doing.
    words = sentence[0:].split(' ')
    return words

print(process_string_to_array('If you were a vegetable, you’d be a ‘cute-cumber.'))
