...
class Food:
    def __init__(self, name, prep_time, veggie, food_type, cuisine, ingred, recipe):
        self.name = name
...
food1 = Food('butternut squash soup', 45, True, 'soup', 'North African', \
...
food2 = Food('shirazi salad', 5, True, 'salad', 'Iranian', \
...
for food in foods:
    ...
    print("Is Veggie?", 'Yes' if food.veggie ßelse "No")
    print("Food Type:", food.food_type)
    print("Cuisine:", food.cuisine)
    for item in food.ingred:
        print(item, end=', ')
    print()
